    ...
    public partial class InitialMovies : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_movies_casts", x => new { x.movie_id, x.person_id });
                    table.ForeignKey(
                        name: "fk_movies_casts_movies_movie_id",
                        column: x => x.movie_id,
                        principalSchema: "movies",
                        principalTable: "movies",
                        principalColumn: "movie_id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "fk_movies_casts_persons_person_id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "fk_movies_crews_people_person_id",
                        column: x => x.person_id,
                        principalSchema: "movies",
                        principalTable: "persons",
                        principalColumn: "person_id",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_movies_casts_person_id",
                schema: "movies",
                table: "movies_casts",
                column: "person_id");
